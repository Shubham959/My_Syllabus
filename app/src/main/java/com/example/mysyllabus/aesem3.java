...
public class aesem3 extends AppCompatActivity {
    TextView detailsText, detailstext1, detailstext2, detailstext3, detailstext4, detailstext5, detailstext6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aesem3);
