...
public class csesem7ele extends AppCompatActivity {

    TextView detailsText, detailstext1, detailstext2, detailstext3,detailstext4,detailstext5,detailstext6,detailstext7;
    LinearLayout layout, layout1, layout2, layout3, layout4, layout5, layout6, layout7;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_csesem7ele);
