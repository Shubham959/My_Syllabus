...
public class MechanicalSem7 extends AppCompatActivity {

    TextView detailsText, detailstext1, detailstext2, detailstext3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanical_sem7);
        ...
        button4.setOnClickListener(v -> {
            Intent intent=new Intent(getApplicationContext(), me_elective_sem7.class);
